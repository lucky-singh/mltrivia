...
const languageString = {
  en: {
    translation: {
      ...
      NEW_GAME_MESSAGE: 'Welcome to %s. , I could help you to become machine learning expert by playing quiz.',
      ...
      GAME_OVER_MESSAGE: 'You got %s out of %s questions correct. I\'d like to add your name to the leaderboard, what\'s your name?',
...
const HighScoreHandler = {
  ...
  handle(handlerInput) {
    ...
    return docClient.scan(params).promise().then((data) => {
        ...
        return handlerInput.responseBuilder
            .speak('Leaderboard queried, highest score goes to ' + scores[0].name + ', ' + scores[1].name + ', and ' + scores[2].name + '.')
            .getResponse();
    })
    .catch((error) => {
...
const DisplayImg1 = {
      title: 'acg1',
      url: 'https://s3.amazonaws.com/mltrivia/black-wallpaper-textured-background.jpg'
};
