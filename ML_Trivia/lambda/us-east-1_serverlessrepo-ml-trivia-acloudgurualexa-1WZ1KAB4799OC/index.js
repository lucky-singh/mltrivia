...
const languageString = {
  en: {
    translation: {
      ...
      NEW_GAME_MESSAGE:
        "Welcome to %s. I could help you to become machine learning expert by playing quiz.",
      WELCOME_MESSAGE:
      ...
      GAME_OVER_MESSAGE:
        "You got %s out of %s questions correct. I'd like to add your name to the leaderboard, what's your name?",
  ...
  handle(handlerInput) {
    ...
    ddb.getItem(params, function (err, data) {
      if (err) {
        ...
        if (data.Item != undefined) {
          score = (parseInt(score) + parseInt(data.Item.score.S)).toString();
          console.log(" -", data.Item.name.S + ": " + data.Item.score.S, "Score: ", score);
        }
        ...
        ddb.putItem(params2, function (err, data) {
          if (err) {
            ...
            console.log("Success! New entry made into database", data);
          }
        });
      }
    });
    ...
    return handlerInput.responseBuilder
      .speak(
        "Thanks " +
        name +
        "! Your score has been added to the leader board. Thanks for playing!"
      )
      .getResponse();
  }
};
  ...
  handle(handlerInput) {
    ...
    return docClient
      ...
      .then(data => {
        ...
        return handlerInput.responseBuilder
          .speak(
            "Leaderboard queried, highest score goes to " +
            scores[0].name +
            ", " +
            scores[1].name +
            ", and " +
...
const DisplayImg1 = {
  title: "acg1",
  url:
    "https://s3.amazonaws.com/mltrivia/black-wallpaper-textured-background.jpg"
};
